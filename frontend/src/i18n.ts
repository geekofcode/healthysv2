...
const resources = {
  en: {translation: {
    ...
    errors: {forbidden: 'Access denied: you do not have the required permissions.', unexpected: 'An unexpected error occurred.', sessionExpired: 'Your session has expired.', requestFailed: 'The request failed.'},
  ...
  fr: {translation: {
    ...
    errors: {forbidden: "Accès refusé : vous ne disposez pas des droits nécessaires.", unexpected: 'Une erreur inattendue est survenue.', sessionExpired: 'Votre session a expiré.', requestFailed: 'La requête a échoué.'},
